...
class LLMServiceClass(llm_service_pb2_grpc.LLMServiceServicer):
  ...
  async def LLMChat(self, request, context):
    ...
    graph_input = {"messages": messages, "model_info": {"name": request.model}}
